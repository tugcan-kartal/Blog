    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-6">
      {posts.map((item) => (
        <Link href={`/blog/${item._id}`} key={item._id} className="group">
          <div className="bg-white lg:w-[20vw] w-[80vw] max-h-[60vh] overflow-y-scroll mx-auto shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
